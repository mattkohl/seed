...
Revision ID: d1db2d69313e
Revises: 
Create Date: 2019-06-10 18:05:30.481108
...
def upgrade():
    ...
    op.create_index(op.f('ix_sections_timestamp'), 'sections', ['timestamp'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_sections_timestamp'), table_name='sections')
